...
function handleMcp({ message, access, pageFrom }) {
    ...
    if (method === 'tools/call') {
        ...
        if (name === 'rateninja_list_my_rates') return rpcResult(id, toolResult(listPartnerRates(access, pageFrom(args))));
        ...
        if (name === 'rateninja_list_my_sailings') return rpcResult(id, toolResult(listPartnerSailings(access, pageFrom(args))));
